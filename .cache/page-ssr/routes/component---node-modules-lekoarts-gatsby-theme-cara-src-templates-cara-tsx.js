...
// EXTERNAL MODULE: external "/Users/dominique/dev/Portfolio-Gatsby/DoBa90.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(5831);
;// CONCATENATED MODULE: ./node_modules/theme-ui/node_modules/@theme-ui/css/dist/theme-ui-css.esm.js
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
// EXTERNAL MODULE: ./node_modules/@lekoarts/gatsby-theme-cara/src/components/layout.tsx + 1 modules
var layout = __webpack_require__(1972);
// EXTERNAL MODULE: ./node_modules/theme-ui/dist/theme-ui.esm.js
var theme_ui_esm = __webpack_require__(8733);
...
function MDXContent(_ref) {
  ...
  return (0,esm/* mdx */.kt)(MDXLayout, Object.assign({}, layoutProps, props, {
    ...
    mdxType: "MDXLayout"
  }), (0,esm/* mdx */.kt)("h1", null, `Welcome !!!`), (0,esm/* mdx */.kt)("h1", null, `my name is Dominique Bataille`), (0,esm/* mdx */.kt)("p", null, `& I am Frontend Developer in Germany.`));
}
;
...
function projects_MDXContent(_ref) {
  ...
  return (0,esm/* mdx */.kt)(projects_MDXLayout, Object.assign({}, projects_layoutProps, props, {
    components: components,
    mdxType: "MDXLayout"
  }), (0,esm/* mdx */.kt)("h2", null, `Projects`), (0,esm/* mdx */.kt)(ProjectCard, {
    title: "Artist booking Site",
    link: "https://github.com/DoBa90/Artist-Booking-App",
    bg: "linear-gradient(to right, #662D8C 0%, #ED1E79 100%)",
    mdxType: "ProjectCard"
  }, "It was an final project of Udacity.com and is a musical venue and artist booking site that facilitates the discovery and bookings of shows between local performing artists and venues. This site lets you list new artists and venues, discover them, and list shows with artists as a venue owner. I built the data models to power the API endpoints by connecting to a PostgreSQL database for storing, querying, and creating information."), (0,esm/* mdx */.kt)(ProjectCard, {
    title: "Creating own recipe page ... TBA",
    bg: "linear-gradient(to right, #662D8C 0%, #ED1E79 100%)",
    mdxType: "ProjectCard"
  }, "Since I love to cook and bake I am going to build my own recipe page where I can add, edit, find and delete new recipe pages. For better search every recipe will be targeted by labels with which you are able to find new recipes in your database that fit to your needs."));
}
;
...
function about_MDXContent(_ref) {
  ...
  return (0,esm/* mdx */.kt)(about_MDXLayout, Object.assign({}, about_layoutProps, props, {
    components: components,
    mdxType: "MDXLayout"
  }), (0,esm/* mdx */.kt)("h2", null, `Personal Values`), (0,esm/* mdx */.kt)("blockquote", null, (0,esm/* mdx */.kt)("p", {
    parentName: "blockquote"
  }, `Life Long Learning `)), (0,esm/* mdx */.kt)("p", null, `This has a huge impact why I love my job. I love to learn new things, technologies, new features, which can be really challenging and also overwhelming sometimes but at the time it keeps me motivated and I never want to stop till I found out why.`), (0,esm/* mdx */.kt)("blockquote", null, (0,esm/* mdx */.kt)("p", {
    parentName: "blockquote"
  }, `Teamwork `)), (0,esm/* mdx */.kt)("p", null, `People make work great. Learning from each other, laughing together, spending good moments, celebrating success and also help each other when things do not work like it should. Everything is better together and together we are stronger, smarter and faster.`), (0,esm/* mdx */.kt)("blockquote", null, (0,esm/* mdx */.kt)("p", {
    parentName: "blockquote"
  }, `Fail forward and take responsibility`)), (0,esm/* mdx */.kt)("p", null, `Failures are a part of life. If you make them, you learn, if you don't make any, you don't make anything. In a ideal culture we should accept when failures happened, we should take responsibility for it, clean it, learn from it and it is not going to happen again.`), (0,esm/* mdx */.kt)("blockquote", null, (0,esm/* mdx */.kt)("p", {
    parentName: "blockquote"
  }, `Take calulated risks`)), (0,esm/* mdx */.kt)("p", null, `We live in a world that is rapidly evolving. If we want to stay with it, we sometimes have to take risks and try new things. But these should be calculated and, if possible, based on data.`), (0,esm/* mdx */.kt)("blockquote", null, (0,esm/* mdx */.kt)("p", {
    parentName: "blockquote"
  }, `Respect and Tolerance`)), (0,esm/* mdx */.kt)("p", null, `Respect is one of my most important values based on my experience. No matter who you are, where you come from, what you look like, what you do, all people deserve to be treated with respect. No one is better or worse because everyone does their best out of their own situation.`), (0,esm/* mdx */.kt)("blockquote", null, (0,esm/* mdx */.kt)("p", {
    parentName: "blockquote"
  }, `Honestly and Feedback`)), (0,esm/* mdx */.kt)("p", null, `I believe that you can say everything honestly without hurting or attacking anyone. Above all, the right choice of words plays a decisive role. Because feedback gives you the opportunity to look at yourself from a different perspective and to develop further. Nobody is perfect, and nobody will be perfect, but we can get closer to being almost perfect. `));
}
;
...
;// CONCATENATED MODULE: ./node_modules/@theme-ui/components/node_modules/@theme-ui/css/dist/theme-ui-css.esm.js
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
function theme_ui_css_esm_get(obj, path, fallback, p, undef) {
  var pathArray = path && typeof path === 'string' ? path.split('.') : [path];
...
var getObjectWithVariants = function getObjectWithVariants(obj, theme) {
  if (obj && obj['variant']) {
    ...
    for (var key in obj) {
      ...
      if (key === 'variant') {
        var val = typeof x === 'function' ? x(theme) : x;
        var variant = getObjectWithVariants(theme_ui_css_esm_get(theme, val), theme);
        result = _extends({}, result, variant);
      } else {
        result[key] = x;
      }
...
var positiveOrNegative = function positiveOrNegative(scale, value) {
  if (typeof value !== 'number' || value >= 0) {
    if (typeof value === 'string' && value.startsWith('-')) {
      ...
      var _n = theme_ui_css_esm_get(scale, valueWithoutMinus, valueWithoutMinus);
    ...
    return theme_ui_css_esm_get(scale, value, value);
  }

  var absolute = Math.abs(value);
  var n = theme_ui_css_esm_get(scale, absolute, absolute);
  if (typeof n === 'string') return '-' + n;
  return Number(n) * -1;
};
...
var css = function css(args) {
  ...
  return function (props) {
    ...
    for (var key in styles) {
      ...
      var prop = key in aliases ? aliases[key] : key;
      var scaleName = prop in scales ? scales[prop] : undefined;
      var scale = scaleName ? theme == null ? void 0 : theme[scaleName] : theme_ui_css_esm_get(theme, prop, {});
      var transform = theme_ui_css_esm_get(transforms, prop, theme_ui_css_esm_get);
      var value = transform(scale, val, val);
...
var index_esm_defaultTheme = {
  space: [0, 4, 8, 16, 32, 64, 128, 256, 512],
  fontSizes: [12, 14, 16, 20, 24, 32, 48, 64, 72]
};
var index_esm_aliases = {
  bg: 'backgroundColor',
  m: 'margin',
  mt: 'marginTop',
  mr: 'marginRight',
...
var index_esm_positiveOrNegative = function positiveOrNegative(scale, value) {
  if (typeof value !== 'number' || value >= 0) {
...
var index_esm_transforms = ['margin', 'marginTop', 'marginRight', 'marginBottom', 'marginLeft', 'marginX', 'marginY', 'top', 'bottom', 'left', 'right'].reduce(function (acc, curr) {
  var _extends2;

  return index_esm_extends({}, acc, (_extends2 = {}, _extends2[curr] = index_esm_positiveOrNegative, _extends2));
}, {});
var index_esm_responsive = function responsive(styles) {
  return function (theme) {
    var next = {};
    var breakpoints = dist_index_esm_get(theme, 'breakpoints', index_esm_defaultBreakpoints);
    var mediaQueries = [null].concat(breakpoints.map(function (n) {
      return "@media screen and (min-width: " + n + ")";
    }));
...
var index_esm_css = function css(args) {
  return function (props) {
    ...
    var theme = index_esm_extends({}, index_esm_defaultTheme, {}, props.theme || props);

    var result = {};
    var obj = typeof args === 'function' ? args(theme) : args;
    var styles = index_esm_responsive(obj)(theme);
    ...
    for (var key in styles) {
      ...
      var prop = dist_index_esm_get(index_esm_aliases, key, key);
      var scaleName = dist_index_esm_get(index_esm_scales, prop);
      var scale = dist_index_esm_get(theme, scaleName, dist_index_esm_get(theme, prop, {}));
      var transform = dist_index_esm_get(index_esm_transforms, prop, dist_index_esm_get);
      var value = transform(scale, val, val);

      if (index_esm_multiples[prop]) {
        var dirs = index_esm_multiples[prop];
...
/* harmony default export */ const css_dist_index_esm = (index_esm_css);
...
var theme_ui_components_esm_variant = function variant(_ref) {
  ...
  return css(theme_ui_css_esm_get(theme, __themeKey + '.' + variant, theme_ui_css_esm_get(theme, variant)));
};
...
function contact_MDXContent(_ref) {
  ...
  return (0,esm/* mdx */.kt)(contact_MDXLayout, Object.assign({}, contact_layoutProps, props, {
    components: components,
    mdxType: "MDXLayout"
  }), (0,esm/* mdx */.kt)("h2", null, `Get in touch`), (0,esm/* mdx */.kt)("p", null, `Visit `, (0,esm/* mdx */.kt)("a", {
    parentName: "p",
    "href": ""
  }, `my website`), ` or find me on other platforms: `, (0,esm/* mdx */.kt)("a", {
    parentName: "p",
    "href": "https://www.linkedin.com/in/dominique-bataille-545463144/"
  }, `LinkedIn`), ` & `, (0,esm/* mdx */.kt)("a", {
    parentName: "p",
    "href": "https://www.xing.com/profile/Dominique_Bataille"
  }, `Xing`)));
}
;
